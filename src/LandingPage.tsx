  ...
  return (
    <>
      <main className="container mx-auto px-6 py-12 max-w-4xl">
        ...
        <section>
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 text-center">Have You Ever Wondered Why It's So Hard to "Just Stop"?</h2>
          ...
          <div className="mt-6 bg-white p-6 rounded-lg shadow-sm border border-gray-200">
            <p className="text-center text-lg"><span className="font-semibold">Cue</span> (feeling bored or stressed) → <span className="font-semibold">Craving</span> → <span className="font-semibold">Response</span> (watching porn) → <span className="font-semibold">Reward</span> (intense dopamine rush).</p>
          </div>
        ...
        <section>
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 text-center">It's More Than Just Brain Chemistry</h2>
          ...
          <h3 className="mt-6 text-xl font-semibold text-gray-800 text-center">When are you most likely to turn to the screen?</h3>
          <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="bg-white p-4 rounded-lg border border-gray-200 text-center">When you're feeling <strong className="text-red-600">Stressed?</strong></div>
            <div className="bg-white p-4 rounded-lg border border-gray-200 text-center">When you're feeling <strong className="text-yellow-600">Bored?</strong></div>
            <div className="bg-white p-4 rounded-lg border border-gray-200 text-center">When you're feeling <strong className="text-blue-600">Lonely?</strong></div>
            <div className="bg-white p-4 rounded-lg border border-gray-200 text-center">When you're feeling <strong className="text-indigo-600">Anxious?</strong></div>
          </div>
          <p className="mt-6 text-lg text-gray-700">
        ...
        <section id="quiz-section" className="bg-white p-6 sm:p-8 rounded-xl shadow-lg border border-gray-200">
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 text-center">The 60-Second Self-Awareness Quiz</h2>
          <p className="mt-3 text-lg text-gray-600 text-center">Answer these 5 questions honestly to see your pattern more clearly.</p>
          ...
          <form id="awareness-quiz" onSubmit={handleSubmit} className={`mt-8 space-y-8 ${isLoading ? 'hidden' : ''}`}>
            {/* Question 1 */}
            <div>
              <p className="font-semibold text-lg text-gray-800">1. After you engage in the habit, how do you typically feel?</p>
              <div className="mt-3 space-y-2">
                <div className="quiz-option">
                  <input 
                    ...
                    className="hidden"
                  />
                  <label htmlFor="q1a" className="block w-full p-4 border border-gray-300 rounded-lg cursor-pointer quiz-option-label">A brief sense of relief, followed by a wave of shame or regret.</label>
                </div>
                <div className="quiz-option">
                  <input 
                    type="radio" 
                    ...
                    className="hidden"
                  />
                  <label htmlFor="q1b" className="block w-full p-4 border border-gray-300 rounded-lg cursor-pointer quiz-option-label">Mostly fine, but I worry about the time I've wasted.</label>
                </div>
                <div className="quiz-option">
                  <input 
                    type="radio" 
                    ...
                    className="hidden"
                  />
                  <label htmlFor="q1c" className="block w-full p-4 border border-gray-300 rounded-lg cursor-pointer quiz-option-label">Emotionally numb or empty.</label>
                </div>
              </div>
            </div>
            ...
            {/* Question 2 */}
            <div>
              <p className="font-semibold text-lg text-gray-800">2. How has the time you spend on this habit changed over the last year?</p>
              <div className="mt-3 space-y-2">
                <div className="quiz-option">
                  <input 
                    type="radio" 
                    ...
                    className="hidden"
                  />
                  <label htmlFor="q2a" className="block w-full p-4 border border-gray-300 rounded-lg cursor-pointer quiz-option-label">It has noticeably increased.</label>
                </div>
                <div className="quiz-option">
                  <input 
                    type="radio" 
                    ...
                    className="hidden"
                  />
                  <label htmlFor="q2b" className="block w-full p-4 border border-gray-300 rounded-lg cursor-pointer quiz-option-label">It has stayed about the same.</label>
                </div>
                <div className="quiz-option">
                  <input 
                    type="radio" 
                    ...
                    className="hidden"
                  />
                  <label htmlFor="q2c" className="block w-full p-4 border border-gray-300 rounded-lg cursor-pointer quiz-option-label">It varies wildly depending on my stress levels.</label>
                </div>
              </div>
            </div>
            ...
            {/* Question 3 */}
            <div>
              <p className="font-semibold text-lg text-gray-800">3. Have you found yourself looking at content you once considered too extreme or strange?</p>
              <div className="mt-3 space-y-2">
                <div className="quiz-option">
                  <input 
                    type="radio" 
                    ...
                    className="hidden"
                  />
                  <label htmlFor="q3a" className="block w-full p-4 border border-gray-300 rounded-lg cursor-pointer quiz-option-label">Yes, my tastes have definitely escalated over time.</label>
                </div>
                <div className="quiz-option">
                  <input 
                    type="radio" 
                    ...
                    className="hidden"
                  />
                  <label htmlFor="q3b" className="block w-full p-4 border border-gray-300 rounded-lg cursor-pointer quiz-option-label">Sometimes, out of curiosity.</label>
                </div>
                <div className="quiz-option">
                  <input 
                    type="radio" 
                    ...
                    className="hidden"
                  />
                  <label htmlFor="q3c" className="block w-full p-4 border border-gray-300 rounded-lg cursor-pointer quiz-option-label">No, I stick to the same types of content.</label>
                </div>
              </div>
            </div>
            ...
            {/* Question 4 */}
            <div>
              <p className="font-semibold text-lg text-gray-800">4. Do you use porn and masturbation as a way to cope with stress, loneliness, or boredom?</p>
              <div className="mt-3 space-y-2">
                <div className="quiz-option">
                  <input 
                    type="radio" 
                    ...
                    className="hidden"
                  />
                  <label htmlFor="q4a" className="block w-full p-4 border border-gray-300 rounded-lg cursor-pointer quiz-option-label">Yes, it's one of my main ways to deal with those feelings.</label>
                </div>
                <div className="quiz-option">
                  <input 
                    type="radio" 
                    ...
                    className="hidden"
                  />
                  <label htmlFor="q4b" className="block w-full p-4 border border-gray-300 rounded-lg cursor-pointer quiz-option-label">Sometimes, but not always.</label>
                </div>
                <div className="quiz-option">
                  <input 
                    type="radio" 
                    ...
                    className="hidden"
                  />
                  <label htmlFor="q4c" className="block w-full p-4 border border-gray-300 rounded-lg cursor-pointer quiz-option-label">No, it's completely separate from my emotional state.</label>
                </div>
              </div>
            </div>
            ...
            {/* Question 5 */}
            <div>
              <p className="font-semibold text-lg text-gray-800">5. If you could press a button and be free of this cycle tomorrow, would you?</p>
              <div className="mt-3 space-y-2">
                <div className="quiz-option">
                  <input 
                    type="radio" 
                    ...
                    className="hidden"
                  />
                  <label htmlFor="q5a" className="block w-full p-4 border border-gray-300 rounded-lg cursor-pointer quiz-option-label">Absolutely, in a heartbeat.</label>
                </div>
                <div className="quiz-option">
                  <input 
                    type="radio" 
                    ...
                    className="hidden"
                  />
                  <label htmlFor="q5b" className="block w-full p-4 border border-gray-300 rounded-lg cursor-pointer quiz-option-label">I'm not sure. Part of me would miss it.</label>
                </div>
                <div className="quiz-option">
                  <input 
                    type="radio" 
                    ...
                    className="hidden"
                  />
                  <label htmlFor="q5c" className="block w-full p-4 border border-gray-300 rounded-lg cursor-pointer quiz-option-label">I think about it often.</label>
                </div>
              </div>
            </div>
            ...
            <div className="text-center pt-4">
              ...
              <button type="submit" className="cta-button w-full sm:w-auto bg-blue-600 text-white font-bold text-lg px-12 py-4 rounded-lg shadow-lg hover:bg-blue-700">
                See My Pattern
              </button>
            </div>
          </form>
        ...
        <section id="results-section" className={`${showResults ? '' : 'hidden'} mt-16 bg-white p-6 sm:p-10 rounded-xl shadow-2xl border-2 border-blue-500`}>
          <div className="text-center">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900">Your answers show you're in a common but difficult cycle.</h2>
            ...
            <p className="mt-4 text-xl font-semibold text-blue-700 max-w-2xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="md:w-2/3">
              <span className="text-sm font-semibold text-blue-600 uppercase tracking-wider">THE NEXT STEP</span>
              <h3 className="text-3xl font-bold text-gray-900 mt-2">Introducing: <br /><span className="text-blue-700">Reclaim Your Focus</span></h3>
              <p className="mt-4 text-lg text-gray-700">
          ...
          <div className="mt-10 text-center">
            ...
            <p className="mt-4 text-sm text-gray-600"><strong>30-Day Money-Back Guarantee:</strong> If this guide doesn't help you, get a full refund. No questions asked.</p>
          </div>
        </section>
      </main>
      <Footer />
        ...
        <div className="popup-overlay">
          <div className="popup-content">
            ...
            <div className="popup-body">
              <p className="text-gray-600 mb-6">Enter your phone number to complete the payment of <strong>30,000 Tsh</strong></p>
