-- Olerum Engineering Database Schema for Supabase
-- This schema creates all necessary tables for the Olerum Engineering website
...
VALUES ('admin', 'admin@olerum-engineering.org', '$2a$10$default_hash_here', 'admin')
ON CONFLICT (username) DO NOTHING;

-- Insert sample data for testing
INSERT INTO hero_images (title, description, image_url, alt_text, order_index) VALUES
('Environmental Engineering Excellence', 'Leading sustainable solutions for a better future', 'https://images.unsplash.com/photo-1542601906990-b4d3fb778b09', 'Environmental engineering project', 1),
('Sustainable Development', 'Innovative approaches to environmental challenges', 'https://images.unsplash.com/photo-1473341304170-971dccb5ac1e', 'Sustainable development concept', 2),
('Green Technology', 'Advancing eco-friendly engineering solutions', 'https://images.unsplash.com/photo-1451187580459-43490279c0fa', 'Green technology innovation', 3)
...
-- These are example permissions - adjust according to your security requirements
